  ...
  translation: {
    ...
    page: {
      ...
      portfolio: {
        ...
        project_3: {
          description:
            'VoiceToon は、没入感のある読書体験を提供することを目的とした、音声対応の小説プラットフォームです。現代的なウェブ技術とAIによるコンテンツ生成を融合し、ユーザーは魅力的な物語を読むだけでなく、音声読み上げ機能も楽しめます。Web Speech API を活用することで、物語の一文一文に命を吹き込み、「聞く」読書体験を実現。読み物をより生き生きと、楽しいものへと変え、まったく新しいデジタル読書体験を創造します。 VoiceToon はまた、クリエイターのためのゆりかごでもあります。作品のアップロード、章の管理、コミュニティとの交流に至るまで、すべてのステップを丁寧に設計した創作ツールを提供。読者はここで新しい世界を発見し、作者は物語を共有しながら、この時代ならではの文学作品を共に創り上げていきます。',
        },
      },
      skyLog: {
        search: '検索',
      ...
      chatRoom: {
        ...
        joinChatRoom: 'チャットルームに参加',
        leaveChatRoom: 'チャットルームから退出',
      ...
      restaurantFinder: {
        ...
        yourLocation: 'あなたの位置',
        rating: '平均評価',
        userRatingCount: 'ユーザー評価数',
        businessStatus: {
          title: '営業状態',
          OPERATIONAL: '営業中',
          CLOSED_PERMANENTLY: '永久休業',
          CLOSED_TEMPORARILY: '休業中',
        },
        minRating: '最低評価',
